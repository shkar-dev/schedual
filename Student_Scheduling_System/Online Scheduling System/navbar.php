...
<nav class="navbar navbar-default">
    ...
    <ul class="nav navbar-nav">
        ...
        <li><a href="addcourse.php"><span class="glyphicon glyphicon-plus-sign"></span> Year</a></li>
        ...
        <li><a href="Schedule_all.php"><span class="glyphicon glyphicon-calendar"></span>All Schedule</a></li>
    </ul>
